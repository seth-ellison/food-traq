...
public class RestConfig {
	...
	public void restConfig() {
		 ...
		 *  to work.
		 *  
		 *  We should probably just automate this to expose Ids for every class.
		 */
		
		// Find all classes under com.FoodTracker.model.daos" and expose their classes for IDs

		
		FastClasspathScanner scanner = new FastClasspathScanner("com.FoodTracker.interview.model.daos");
